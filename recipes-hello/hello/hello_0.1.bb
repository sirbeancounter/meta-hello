...
SRC_URI += "file://0001-Generate-hello.boot-file.patch"
SRC_URI += "file://0002-Update-hello.start.in-to-use-heelo.boot.patch"
...
do_install_append() {
    ...
    install -m 0755 ${S}/sys/hello.boot ${D}${EBIN_DIR}
